...
*** Version 1.4: New feature, =imenu= support
  #+html: <p align="center"><img src="img/imenu-1.png" width="80%"/></p>
  #+html: <p align="center"><img src="img/imenu-2.png" width="80%"/></p>
  #+html: <p align="center"><img src="img/imenu-3.png" width="80%"/></p>
  #+html: <p align="center"><img src="img/imenu-4.png" width="80%"/></p>

** Screenshots with =outline= minior mode
*** Version 1.5: New feature, =outline minior mode= support (use =org-cycle= and =org-shifttab=)
  #+html: <p align="center"><img src="img/outline-1.png" width="80%"/></p>
  #+html: <p align="center"><img src="img/outline-2.png" width="80%"/></p>
...
This package supports =imenu= and =outline= minior mode, enable by default. However,
no default keybindings provided. Follow
#+html: <a href="#keybindings">Keybinding-Settings</a>
to setup.
