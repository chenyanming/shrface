...
** Screenshots when using =dash-docs=
  ...
  Version *1.2*: New face =shrface-verbatim=, unleash the full power of =dash-docs=:
  #+html: <p align="center"><img src="img/dash-doc-verbatim.png" width="80%"/></p>
...
** =2020-04-12=
Version *1.2*:
- Updated face: =shrface-highlight=
