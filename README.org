...
[[https://melpa.org/#/shrface][file:https://melpa.org/packages/shrface-badge.svg]]  [[melpazoid][https://github.com/chenyanming/shrface/workflows/melpazoid/badge.svg]]
...
=M-x= =shrface-links-counsel= to list all URLs. You can jump around all URLs with
ivy(counsel).
