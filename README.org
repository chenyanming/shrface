...
*** Version 1.3: New face =shrface-code=, unleash the full power of =dash-docs=
  #+html: <p align="center"><img src="img/dash-doc-code.png" width="80%"/></p>
...
by the package expect the experimental features (check the section [[Experimental
faces]] if you want to enable):
#+BEGIN_SRC emacs-lisp
(require 'shrface)
#+END_SRC
