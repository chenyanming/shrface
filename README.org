...
- [[#description][Description]]
  ...
  - [[#screenshots-with-outline-minior-mode][Screenshots with =outline= minior mode]]
...
** Screenshots when using =eww=
  #+html: <p align="center"><img src="img/eww-1.png" width="50%"/></p>
  #+html: <p align="center"><img src="img/eww-2.png" width="50%"/></p>

** Screenshots when using =dash-docs=
  #+html: <p align="center"><img src="img/dash-doc-1.png" width="50%"/></p>
  #+html: <p align="center"><img src="img/dash-doc-2.png" width="50%"/></p>

*** Version 1.3: New face =shrface-code=, unleash the full power of =dash-docs=
  #+html: <p align="center"><img src="img/dash-docs-code.png" width="50%"/></p>

** Screenshots when using =nov.el=
  #+html: <p align="center"><img src="img/epub-1.png" width="50%"/></p>
  #+html: <p align="center"><img src="img/epub-2.png" width="50%"/></p>

** Screenshots when using =mu4e=
  #+html: <p align="center"><img src="img/mu4e.png" width="50%"/></p>

** Screenshots when using =imenu-list=, =helm-imenu=, =counsel-imenu=
*** Version 1.4: New feature, =imenu= support
  #+html: <p align="center"><img src="img/imenu-1.png" width="50%"/></p>
  #+html: <p align="center"><img src="img/imenu-2.png" width="50%"/></p>
  #+html: <p align="center"><img src="img/imenu-3.png" width="50%"/></p>
  #+html: <p align="center"><img src="img/imenu-4.png" width="50%"/></p>

** Screenshots with =outline= minior mode
*** Version 1.5: New feature, =outline minior mode= support (use =org-cycle= and =org-shifttab=)
  #+html: <p align="center"><img src="img/outline-1.png" width="50%"/></p>
  #+html: <p align="center"><img src="img/outline-2.png" width="50%"/></p>

* Prerequisites
This package uses =shr=, =org=, =imenu=, =outline=, and =org-bullets= (optional)
...
PS: The default setting is derived from  =org-bullets-bullet-list=, if =org-bullets=
is available.
